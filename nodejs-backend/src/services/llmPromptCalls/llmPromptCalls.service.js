...
const { LoginHistory } = require("./llmPromptCalls.class");
const createModel = require("../../models/llmPromptCalls.model");
const hooks = require("./llmPromptCalls.hooks");
...
module.exports = function (app) {
  ...
  app.use("/llmPromptCalls", new LoginHistory(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("llmPromptCalls");

  // Get the schema of the collections
  app.get("/llmPromptCallsSchema", function (request, response) {
