const { TokenUsage } = require("./tokenUsage.class");
const createModel = require("../../models/tokenUsage.model");
const hooks = require("./tokenUsage.hooks");
...
module.exports = function (app) {
  ...
  app.use("/tokenUsage", new TokenUsage(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("tokenUsage");

  // Get the schema of the collections
  app.get("/tokenUsageSchema", function (request, response) {
