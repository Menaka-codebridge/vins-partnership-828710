const { PromptQueues } = require("./promptQueues.class");
const createModel = require("../../models/promptQueues.model");
const hooks = require("./promptQueues.hooks");
...
module.exports = function (app) {
  ...
  app.use("/promptQueues", new PromptQueues(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("promptQueues");

  // Get the schema of the collections
  app.get("/promptQueuesSchema", function (request, response) {
