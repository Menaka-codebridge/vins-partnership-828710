const { CompanyPositionMappings } = require("./companyPositionMappings.class");
const createModel = require("../../cbModels/companyPositionMappings.model");
const hooks = require("./companyPositionMappings.hooks");
...
module.exports = function (app) {
  ...
  app.use(
    "/companyPositionMappings",
    new CompanyPositionMappings(options, app),
  );

  // Get our initialized service so that we can register hooks
  const service = app.service("companyPositionMappings");

  // Get the schema of the collections
  app.get("/companyPositionMappingsSchema", function (request, response) {
