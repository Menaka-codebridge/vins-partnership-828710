...
const CompanyPositionMappingsDataTable = ({
  items,
  fields,
  onEditRow,
  onRowDelete,
  ...
  const dropdownTemplate1 = (rowData, { rowIndex }) => (
    <p>{rowData.position?.map((pos) => pos.name).join(", ")}</p>
  );
  ...
  const handleDelete = async () => {
    ...
    try {
      const promises = selectedItems.map((item) =>
        client.service("companyPositionMappings").remove(item._id),
      );
  ...
  return (
    <>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <InboxCreateDialogComponent
              ...
              serviceInbox="companyPositionMappings"
              onCreateResult={onCreateResult}
      ...
      <Dialog
        header="Upload CompanyPositionMappings Data"
        visible={showUpload}
      ...
      <Dialog
        header="Search CompanyPositionMappings"
      ...
      <Dialog
        header="Filter CompanyPositionMappings"
        visible={showFilter}
...
export default CompanyPositionMappingsDataTable;
