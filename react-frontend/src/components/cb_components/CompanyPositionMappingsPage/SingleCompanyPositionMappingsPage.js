...
const SingleCompanyPositionMappingsPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .get(urlParams.singleCompanyPositionMappingsId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      .then((res) => {
        ...
        const company = res.company
          ...
          : [];
        setCompany(company);
        const positions = Array.isArray(res.position)
  ...
  }, [props, urlParams.singleCompanyPositionMappingsId]);

  const goBack = () => {
    navigate("/companyPositionMappings");
  };
  ...
  return (
    <ProjectLayout>
      <div className="col-12 flex flex-column align-items-center">
          ...
          <div className="flex align-items-center justify-content-between">
            <div className="flex align-items-center">
              <Button
                ...
                onClick={() => goBack()}
              />
              <h3 className="m-0">Company Position Mapping</h3>
              <SplitButton
                model={menuItems}
        ...
        <CommentsSection
          recordId={urlParams.singleCompanyPositionMappingsId}
          user={props.user}
          alert={props.alert}
          serviceName="companyPositionMappings"
        />
        <div
          id="rightsidebar"
...
export default connect(
  mapState,
  mapDispatch,
)(SingleCompanyPositionMappingsPage);
