...
const TextExtractionQueuesDataTable = ({
  items,
  fields,
  onEditRow,
  onRowDelete,
  ...
  return (
    <>
      ...
      >
        ...
        />
        <Column
          field="caseDocumentId"
          header="Case Document Id"
          body={dropdownTemplate0}
          filter={selectedFilterFields.includes("caseDocumentId")}
          hidden={selectedHideFields?.includes("caseDocumentId")}
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="documentStorageId"
          header="Document Storage Id"
          body={dropdownTemplate1}
          filter={selectedFilterFields.includes("documentStorageId")}
          hidden={selectedHideFields?.includes("documentStorageId")}
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="documentType"
        ...
        <Column
          ...
          filter={selectedFilterFields.includes("caseNo")}
          hidden={selectedHideFields?.includes("caseNo")}
          style={{ minWidth: "8rem" }}
        />
      ...
      <Dialog
        header="Upload TextExtractionQueues Data"
        visible={showUpload}
      ...
      <Dialog
        header="Search TextExtractionQueues"
