...
const TextExtractionQueuesPage = (props) => {
  ...
  const filename = "textExtractionQueues";
  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          caseDocumentId: urlParams.singleCaseDocumentsId,
          documentStorageId: urlParams.singleCaseDocumentsId,
          caseNo: urlParams.singleAccidentCasesId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Text Extraction Queues",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("textExtractionQueues").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
  ...
  return (
    <div className="mt-5">
        ...
        <div className="col-6 flex justify-content-end">
          <>
            ...
            <Button
              ...
              role="textExtractionQueues-add-button"
            />
          </>
        </div>
      </div>
      ...
      <AreYouSureDialog
        ...
        onYes={() => deleteRow()}
      />
      <TextExtractionQueuesEditDialogComponent
