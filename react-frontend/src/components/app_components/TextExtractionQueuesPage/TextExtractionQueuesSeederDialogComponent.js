...
import seederData from "./textExtractionQueues.seeder.json";
...
const TextExtractionQueuesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TextExtractionQueuesSeederDialogComponent);
