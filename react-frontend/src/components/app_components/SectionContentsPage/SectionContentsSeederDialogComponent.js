...
import seederData from "./sectionContents.seeder.json";
...
const SectionContentsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SectionContentsSeederDialogComponent);
