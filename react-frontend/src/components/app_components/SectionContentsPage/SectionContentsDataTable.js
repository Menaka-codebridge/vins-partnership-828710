...
const SectionContentsDataTable = ({
  items,
  fields,
  onEditRow,
  onRowDelete,
  ...
  return (
    <>
      ...
      >
        ...
        />
        <Column
          field="initialInference"
          header="Initial Inference"
          body={pTemplate3}
          filter={selectedFilterFields.includes("initialInference")}
          hidden={selectedHideFields?.includes("initialInference")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          header="Ground Truth"
          body={pTemplate4}
          filter={selectedFilterFields.includes("groundTruth")}
          hidden={selectedHideFields?.includes("groundTruth")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
      ...
      <Dialog
        header="Upload SectionContents Data"
        visible={showUpload}
