...
import seederData from "./caseDocuments.seeder.json";
...
const CaseDocumentsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CaseDocumentsSeederDialogComponent);
