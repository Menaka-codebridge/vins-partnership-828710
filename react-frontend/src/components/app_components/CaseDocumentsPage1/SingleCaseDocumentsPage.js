...
const SingleCaseDocumentsPage = (props) => {
  ...
  const stream = client.service("caseDocuments");

  useEffect(() => {
    //on mount
    client
      .service("caseDocuments")
      .get(urlParams.singleCaseDocumentsId, {
        query: {
          $populate: [
            {
              path: "createdBy",
          ...
          <div className="card w-full">
            <div className="grid ">
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{_entity?.user}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{_entity?.fileType}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Storage Path</label>
                <p className="m-0 ml-3">{_entity?.storagePath}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
                  Extracted Content
                </label>
                <p className="m-0 ml-3">{_entity?.extractedContent}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">UploadTimestamp</label>
                <p id="uploadTimestamp" className="m-0 ml-3">
