...
import seederData from "./groundTruthQueues.seeder.json";
...
const GroundTruthQueuesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(GroundTruthQueuesSeederDialogComponent);
