...
import seederData from "./accidentCases.seeder.json";
...
const AccidentCasesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AccidentCasesSeederDialogComponent);
