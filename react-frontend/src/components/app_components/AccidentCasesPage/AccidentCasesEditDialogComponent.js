...
const AccidentCasesEditDialogComponent = (props) => {
...
parameters: _entity?.parameters,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info accidentCases updated successfully" });
    ...
    return (
        <Dialog header="Edit Accident Cases" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="accidentCases-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="collisionDateTime" value={_entity?.collisionDateTime ? new Date(_entity?.collisionDateTime) : null} onChange={ (e) => setValByKey("collisionDateTime", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
