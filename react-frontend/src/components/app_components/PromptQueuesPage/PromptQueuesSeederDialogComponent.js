...
import seederData from "./promptQueues.seeder.json";
...
const PromptQueuesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PromptQueuesSeederDialogComponent);
