    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Histories",
          type: "error",
          message: error.message || "Failed get Histories",
        });
      });
