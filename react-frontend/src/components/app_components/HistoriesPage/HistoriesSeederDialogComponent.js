...
import seederData from "./histories.seeder.json";
...
const HistoriesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(HistoriesSeederDialogComponent);
