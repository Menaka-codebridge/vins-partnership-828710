...
const SingleHistoriesPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      .service("histories")
      .get(urlParams.singleHistoriesId, {
        query: {
          $populate: [
            {
              path: "createdBy",
          ...
          <div className="card w-full">
            <div className="grid ">
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p id="timestamp" className="m-0 ml-3">
                  {_entity?.timestamp}
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">User Prompt</label>
                <p className="m-0 ml-3">{_entity?.userPrompt}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Parameters Used</label>
                <p className="m-0 ml-3">{_entity?.parametersUsed}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Synonyms Used</label>
                <p className="m-0 ml-3">{_entity?.synonymsUsed}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
                  Response Received
                </label>
                <p className="m-0 ml-3">{_entity?.responseReceived}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Sub Section</label>
