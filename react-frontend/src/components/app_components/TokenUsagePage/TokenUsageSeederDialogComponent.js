...
import seederData from "./tokenUsage.seeder.json";
...
const TokenUsageSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TokenUsageSeederDialogComponent);
