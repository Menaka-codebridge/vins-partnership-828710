...
const TokenUsageEditDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    setLoading(true);
    try {
      await client.service("tokenUsage").patch(_entity._id, _data);
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="tokenUsage-edit-dialog-component"
      >
...
export default connect(mapState, mapDispatch)(TokenUsageEditDialogComponent);
